...
{
    public partial class PurdmatSearch : Form
    {
        public PurdmatSearch()
        {
            InitializeComponent();
        }
        ...
        private void DataGen_Click(object sender, EventArgs e)
        {
            ...
            Vform.QueryExport(getQuery(), new DateTime(), new DateTime(), purdtxt.Text,matnotxt.Text,matnametxt.Text);
